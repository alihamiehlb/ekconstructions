  ...
  return (
    <div className="hero-visual pointer-events-none absolute inset-0 overflow-hidden">
      <Image
        ...
        quality={78}
        sizes="100vw"
        className="hero-ken-burns object-cover object-[68%_center] lg:hidden"
      />
      <Image
        ...
        quality={75}
        sizes="100vw"
        className="hero-ken-burns hidden object-cover object-[center_42%] lg:block lg:object-[center_38%]"
      />
