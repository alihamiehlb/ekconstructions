...
/** Desktop — sits in the open gap between copy and building image */
...
/** Mobile — below CTAs, away from buttons */
export function HeroFloatingSceneMobile({ scrollProgress }: Props) {
  return (
    <SceneLayer
      scrollProgress={scrollProgress}
      className="relative mx-auto mt-10 h-[200px] w-full max-w-[300px] sm:h-[220px] lg:hidden"
    />
  );
}
