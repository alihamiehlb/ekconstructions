  ...
  return (
    <main id="main-content" className="bg-ek-navy pt-[68px] text-white lg:pt-[74px]">
      <div className="relative min-h-[52vh] lg:min-h-[68vh]">
        ...
        <div className="landing-container relative flex h-full min-h-[52vh] flex-col justify-between py-6 sm:py-8 lg:min-h-[68vh] lg:py-10">
          <Link
            href="/gallery"
            className="inline-flex w-fit items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-[10px] font-semibold tracking-[0.18em] text-white uppercase backdrop-blur-sm transition hover:border-ek-teal hover:text-ek-teal"
          >
          ...
          <motion.div
            ...
            className="max-w-3xl pb-4 lg:pb-8"
          >
